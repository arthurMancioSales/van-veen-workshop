...
import { newLeadApi } from "../api/newLeadApi";
import { NewLead } from "../types/leads";
import { newLeadValidation } from "../validation/newLeadValidation";
...
export default function NewLeadForm({
  ...
  return (
    <Formik
      ...
      validationSchema={newLeadValidation}
      onSubmit={async (values) => {
        const { error } = await newLeadApi({
          ...values,
        });
